...
use crate::constants::validation::{
    RFC_1035_LABEL_ERR_MSG, RFC_1035_LABEL_FMT, RFC_1035_LABEL_MAX_LENGTH,
    RFC_1123_LABEL_ERROR_MSG, RFC_1123_LABEL_MAX_LENGTH, RFC_1123_SUBDOMAIN_ERROR_MSG,
    RFC_1123_SUBDOMAIN_FMT, RFC_1123_SUBDOMAIN_MAX_LENGTH,
};
