...
mod tests {
    ...
    fn test_multiple_git_syncs() {
        ...
        insta::assert_snapshot!(
            "multiple_git_syncs_containers",
            serde_yaml::to_string(&git_sync_resources.git_sync_containers).unwrap()
        );

        assert_eq!(3, git_sync_resources.git_sync_init_containers.len());

        insta::assert_snapshot!(
            "multiple_git_syncs_init_containers",
            serde_yaml::to_string(&git_sync_resources.git_sync_init_containers).unwrap()
        );
...
",
    ...
    fn test_git_sync_ca_cert() {
        ...
        insta::assert_snapshot!(
            "git_sync_ca_cert_init_containers",
            serde_yaml::to_string(&git_sync_resources.git_sync_init_containers).unwrap()
        );
